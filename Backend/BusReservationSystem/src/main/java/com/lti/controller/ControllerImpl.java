...
public class ControllerImpl {
	...
	public Status forgotPass(@RequestBody ForgotPassDto forgotPass) {
		...
		try {
			String info = "Your new PassWord is " + n + " . Kindly use this password to login and Go to dashboard & update your ASAP";
			service.sendMail(info, forgotPass.getEmail());
			service.forgotPassword(forgotPass.getEmail(), ""+n);
			Status status = new Status();
	...
	public String addReservation(@RequestBody ResDto obj) throws ParseException {
		...
		try {
			...
			try {
				...
				String info = "Congratulations, Your booking is confirmed.Here is your ticket details..... Name : " + regObj.getFirstName()+" "+ regObj.getLastName()+
						"Ticket No : " + ticketNo + " Bus No : " + routeObj.getBusNo() +
						" Source : " + routeObj.getSource() +"  Destination : " + routeObj.getDestination()+
						"  Date of Journey : " + resObj.getDateOfJourney() + " Booking Date : " + resObj.getBookingDate()+
						" Arrival Time : " + routeObj.getStartTime() + " Reached Time : " + routeObj.getReachTime();
				service.sendMail(info, regObj.getEmail());
			}catch(Exception e) {
				service.addUnAuthorizedUser(resObj, obj.getEmail(), obj.getPhone());
				int ticketNo = service.getTicketNo();
				String info ="Congratulations, Your booking is confirmed.Here is your ticket details.....Ticket No : " + ticketNo + " Bus No : " + routeObj.getBusNo() +
						" Source : " + routeObj.getSource() +"  Destination : " + routeObj.getDestination()+
						"  Date of Journey : " + resObj.getDateOfJourney() + " Booking Date : " + resObj.getBookingDate()+
						" Arrival Time : " + routeObj.getStartTime() + " Reached Time : " + routeObj.getReachTime();
				service.sendMail(info, obj.getEmail());
			}
